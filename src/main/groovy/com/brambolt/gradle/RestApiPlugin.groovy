...
import com.brambolt.gradle.rest.tasks.RestApiTask
import org.gradle.api.Plugin
import org.gradle.api.Project
import org.gradle.api.Task

/**
 * <p>A Gradle plug-in for working with REST APIs.</p>
 *
 * @see com.brambolt.gradle.rest.tasks.RestApiTask
 */
class RestApiPlugin implements Plugin<Project> {
  ...
  void apply(Project project) {
    ...
    createRestApiTask(project)
  }

  protected Task createRestApiTask(Project project) {
    // Apply an empty configuration closure to set defaults:
    project.task([type: RestApiTask], 'rest') {}
  }
}
